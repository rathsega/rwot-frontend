...
import OverviewDashboard from "./components/dashboard/DashboardOverviewOptimized";
import OperationsDashboard from "./components/dashboard/OperationsDashboardOptimized";
...
import CasesListPage from "./components/pages/CasesListPage";
      ...
      <div className="App" id={load ? "no-scroll" : "scroll"}>
        ...
        <Routes>
          ...
          <Route path="/dashboard/*" element={<DashboardLayout />}>
            ...
            <Route path="cases" element={<ProtectedRoute element={CasesListPage} allowedRoles={["Admin", "UW", "Operations", "Telecaller", "KAM", "Banker", "Individual"]} />} />
