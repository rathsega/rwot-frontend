...
import { FaEdit, FaCheckCircle, FaFileAlt } from "react-icons/fa";
import ServerSearchBar from "../../common/ServerSearchBar";

function DocumentationInProgress({ cases, handleRefresh, searchTerm = "", onSearchChange }) {
      ...
      <div className="case-cards-grid">
        {cases.length === 0 ?
          ...
          >
            ...
            No records found in Documentation In Progress.
          </div>
...
export default DocumentationInProgress;